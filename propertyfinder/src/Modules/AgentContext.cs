    ...
    public class AgentContext
    {
       // CommonModule cmn = new CommonModule();
		...
		public AgentModel GetByEmailAddAndPwd(string  emailadd, string pswd)
		{
		    ...
		    String sql = "select AgentId, FirstName, LastName, EmailAddress, Password, ConfirmFlag, ProfileFileName, ProfileUrl  from property_agent where EmailAddress = @0 and Password=@1";
